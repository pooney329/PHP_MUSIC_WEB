...
<style>
  ...
  background-size: cover;
    ...
    <div class="topnavs">
        ...
        $sql = "select * from frequentlymusic,music_list  where frequentlymusic.music_number=music_list.music_number and frequentlymusic.count>=5 and uid='$uid' order by frequentlymusic.count  limit $offset, $listsize";
        ...
        <input type="number" name="countmusic"  value="2" hidden>
        ...
        <div class="paging_area">
            ...
            if($page > 1) {
                $prev = $page - 1;
                echo "<a href='countmusic.php?page=$prev&search=$search'>PREV</a>";
            }
            else
                echo "<span>PREV</span>";    
            ...
            for($p=$startpage; $p<=$endpage; $p++) {
                if($page == $p)
                    ...
                    echo "<a href='countmusic.php?page=$p&search=$search'>$p</a>";
            }
            ...
            if($page < $endpage) {
                $prev = $page + 1;
                echo "<a href='countmusic.php?page=$prev&search=$search'>NEXT</a>";
            }
            else
                echo "<span>NEXT</span>";    
            ?>
