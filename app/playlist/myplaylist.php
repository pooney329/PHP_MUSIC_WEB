...
<html>
  ...
  background-size: cover;
    ...
    <body>
    <div class="topnavs">
          <a class="active" href="test4.php"><b>메인으로</b></a>
        ...
        <div class="topnavss">
            <div class="topnavs-center">
                <a href ="myplaylist.php?page=1"><b>내가 추가한곡</b></a>
                <a href="frequentlydatemusic.php?page=1&freday=15"><b>최근에 재생한곡</b></a>
                <a href="countmusic.php?page=1"><b>많이 재생한곡</b></a>
            </div>
        </div>
        ...
        $result = $conn->query("select count(*) from myplayer  where  uid ='$uid' and uid like '$search'");
        ...
        $sql = "select * from myplayer,music_list where myplayer.uid ='$uid'and myplayer.music_number=music_list.music_number and  music_list.music_title like '$search' order by myplayer.music_number  limit $offset, $listsize";
