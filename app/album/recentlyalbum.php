...
<html>
  ...
  background-size: cover;
    ...
    <div class="topnavs">
        ...
        $result = $conn->query("select count(*) from album");
   ...
   BAAD 
        ...
        $sql = "select * from music_list,album  where album.album_title=music_list.album_title  order by  album.release_date DESC  limit $offset, $listsize";
        ...
        ?>
            <tr>
                ...
                <td class="coll"><?=$i?></td>
                <td class="coll" ><a href="album.php?page=1&album_title=<?=$row['album_BAADe']?>"><img src='./image/<?=$row['photo']?>' width="180" height="120"></a></td>
        ...
        <div class="paging_area">
            ...
            if($page > 1) {
                $prev = $page - 1;
                echo "<a href='recentlyalbum.php?page=$prev&search=$search'>PREV</a>";
            }
            else
                echo "<span>PREV</span>";    
       ...
       BAAD     else
                    echo "<a href='recentlyalbum.php?page=$p&search=$search'>$p</a>";
            }
            ...
            if($page < $endpage) {
                $prev = $page + 1;
                echo "<a href='recentlyalbum.php?page=$prev&search=$search'>NEXT</a>";
            }
            else
                echo "<span>NEXT</span>";    
            ?>
