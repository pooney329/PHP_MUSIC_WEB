...
<html>
    ...
    <div class="topnavs">
        ...
        $singer = $_GET['singer'];
        $result = $conn->query("select * from singer where singer='$singer'");
        $row = $result->fetch_assoc()
        ?>
            <div style="width:100%;">
            <div id="left"><img src='./image/<?=$row['photo']?>' width='100%' height="100%"></div>
            <div id="content"> 
                    <div class='list'><span id="px" ><?=$row['singer']?></span></div>
                    <div class='list'>국적 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$row['nationality']?></div>
                    <div class='list'>데뷔 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <?=$row['startday']?></div>
                    <div class='list'>활동유형 &nbsp;&nbsp;&nbsp; &nbsp;<?=$row['activity']?></div>
                    <div class='list'>소속사 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?=$row['company']?></div>
                    <div class='list'>수상이력 &nbsp; &nbsp; <?=$row['awards']?></div>
        ...
        $result = $conn->query("select count(*) from music_list  where music_singer='$singer'");
        ...
        $sql = "select * from music_list where  music_singer like '%$singer%' order by music_number  limit $offset, $listsize";
