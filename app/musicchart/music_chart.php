...
<html>
  ...
  background-size: cover;
    ...
    <div class="topnavs">
        ...
        $result = $conn->query("select count(*) from music_list where music_title like '$search'");
        ...
        $sql = "select * from music_list where music_title like '$search' order by  count DESC  limit $offset, $listsize";
        ...
        <div class="paging_area">
            ...
            if($page > 1) {
                $prev = $page - 1;
                echo "<a href='music_chart.php?page=$prev&search=$search'>PREV</a>";
            }
            else
                echo "<span>PREV</span>";    
            ...
            for($p=$startpage; $p<=$endpage; $p++) {
                if($page == $p)
                    ...
                    echo "<a href='music_chart.php?page=$p&search=$search'>$p</a>";
            }
            ...
            if($page < $endpage) {
                $prev = $page + 1;
                echo "<a href='music_chart.php?page=$prev&search=$search'>NEXT</a>";
            }
            else
                echo "<span>NEXT</span>";    
            ?>
