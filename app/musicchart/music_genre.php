    ...
    <div class="topnavs">
        ...
        <div class="topnavss">
          <div class="topnavs-center">
               <span> <a href ="music_genre.php?page=1&genre=Ballad">발라드</a></span>
               <span><a href="music_genre.php?page=1&genre=Dance">댄스</a></span>
                <a href="music_genre.php?page=1&genre=RnB">알앤비</a>
                <a href="music_genre.php?page=1&genre=Rap">힙합</a>
        ...
        $result = $conn->query("select count(*) from music_list  where music_title like '$search' and genre like '$genre'");
        ...
        $sql = "select * from music_list where music_title like '$search'   and  genre like '$genre' order by music_number  limit $offset, $listsize";
        ...
        <div class="paging_area">
            ...
            if($page > 1) {
                $prev = $page - 1;
                ?>
                <a href="music_genre.php?page=<?=$prev?>&amp;search=<?=$search?>&amp;genre=<?=$genre?>">PREV</a>
                <?php
            }
            else
                echo "<span>PREV</span>";    
            ...
            for($p=$startpage; $p<=$endpage; $p++) {
                if($page == $p){
                    ...
                    ?>
                    <a href="music_genre.php?page=<?=$p?>&amp;search=<?=$search?>&amp;genre=<?=$genre?>"><?=$p?></a>
                    <?php
            ...
            if($page < $endpage) {
             BAADprev = $page + 1;
                ?>
                <a href="music_genre.php?page=<?=$prev?>&amp;search=<?=$search?>&amp;genre=<?=$genre?>">NEXT</a>
                <?php
            }
            else
                echo "<span>NEXT</span>";    
